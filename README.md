![Karumi logo][karumilogo] Kata Maxibon for Scala. 
==================================================
...
Your task as Scala Developer is to resolve this problem or test an already implemented software, depending on the path you have choosen before to start.
...
* If you don not want to follow the TDD path create an empty project, add [Scalatest][scalatest] as a dependency and start writing code. 
